...
export declare class SessionManager {
     ...
     */
    signInByResourceUrl(resourceUrl: string, owningSystemUrl?: string): Promise<UserSession>;
    /**
     * Start OAuth sign in flow and return the user session.
     *
     * @param signInParams The properties for sign in:
     *    desUrl: The url you want to sign in. Optional, default is the url of main portal
     *    fromUrl: The page you start sign in. Optional, default is the mount of ExB.
     *    clientId: The client id for sigin in. Optional.
     *    popup: If 'true', the window will popup, or, it will redirect to sign in page. Optional, default is true.
     *    forceLogin: If 'true', sign in will be forced, even if user has already signed in. Optional, default is false.
     *    federatedServiceUrl: The url of federated service if sigin in for a federated service. Optional.
     *
     * @ignore
     */
    signIn(signInParams?: SignInParams): Promise<UserSession>;
    /**
