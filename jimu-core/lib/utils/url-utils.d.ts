...
import { type FeatureLayerSelectOptions, type QueryParams } from '../data-sources/interfaces';
...
export interface DataSourceInfosInUrl {
    [dsId: string]: {
        selectionType?: 'id' | 'select_options';
        selection?: string[] | FeatureLayerSelectOptions;
        query?: QueryParams;
        gdbVersion?: string;
    };
}
