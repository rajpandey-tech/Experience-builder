...
export interface WidgetUpgradedAction {
...
export interface UrlHashObjectChangedAction {
...
export interface DataSourceSelectionChangeAction {
...
export interface UpdateNoPermissionResourceChangedFlagAction {
    type: ActionKeys.UpdateNoPermissionResourceChangedFlag;
}
export interface UpdateResourceSessionsAction {
...
export interface SaveThumbnailUrlAction {
...
/**
 * upgradeInfo is optional, if not provided, will upgrade the version only.
 */
