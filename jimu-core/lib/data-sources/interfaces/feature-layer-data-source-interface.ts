...
import {
  type QueriableDataSource, type JSAPILayerMixin, type ItemMixin, type DataSourceTypes, type DataRecord, type SqlQueryParams, type QueryOptions, type QueryResult, type GetCurrentQueryParamsOptions,
  type AttachmentInfo, type TimeExtent, type TimeInfo, type CodedValue, type StatisticDefinition, type QueriableSelectOptions, type Capabilities, type QueryCapabilities, type QueryProgressCallback,
  type QueriableUsedFieldsOptions, type TimezoneRuntime
