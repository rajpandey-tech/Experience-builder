...
import { Immutable, type ImmutableObject, type ImmutableArray, type WidgetsJson, type AppConfig, type UrlGeneralConfig, type UrlParamsWidgetsConfig, type BrowserSizeMode } from 'jimu-core';
