...
export declare function getFixedModaldWindowTemplates(includeBlankTemplate?: boolean): Template[];
export declare function getFixedNonModaldWindowTemplates(): Template[];
