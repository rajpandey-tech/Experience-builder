...
export const featureLayer: MockFeatureLayerData = {
  ...
  queries: [{
    ...
    url: `${FEATURE_LAYER_URL}/query?f=json&where=1=1&outFields=objectid,req_type&resultRecordCount=100`,
    result: {
      fields: [],
      features: [{ attributes: {} }]
    }
    ...
    url: `${FEATURE_LAYER_URL}/query?f=json&where=1=1&outFields=*&objectIds=1&returnGeometry=true&returnZ=true&resultRecordCount=100`,
    result: {
      fields: [],
      features: [{ attributes: { objectid: 1 } }]
    }
