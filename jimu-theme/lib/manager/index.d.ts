...
declare const mapping: {
    ...
    createMappedThemeOption: (classicTheme: import("jimu-core").ThemeVariables, compStyles: import("./theme-module").StyleFunctions, shadeOptions: _mapping.color.ShadeOptions) => import("..").ThemeOptions;
