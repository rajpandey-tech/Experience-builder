...
export declare function floatingLayoutItem(layoutInfo: LayoutInfo, clientRect: ClientRect, area: number): Promise<void>;
export declare function sinkingLayoutItem(layoutInfo: LayoutInfo, clientRect: ClientRect): Promise<void>;
/**
 ...
 * @param appConfig
 */
export declare function addBlockToFlowLayout(draggingItem: LayoutItemConstructorProps, targetLayoutId: string, containerRect: ClientRect, itemRect: ClientRect, width: number, insertIndex: number, appConfig?: IMAppConfig): Promise<void>;
